  ...
  group('AssetThumbnail', () {
    testWidgets('shows placeholder icon for audio type', (tester) async {
      await tester.pumpWidget(_wrap(
        AssetThumbnail(asset: _fakeAsset(type: 'audio')),
      ));
      await tester.pumpAndSettle();

      expect(
        find.byIcon(FluentIcons.music_in_collection),
        findsWidgets,
      );
    });
    ...
    testWidgets('shows text document icon for text type', (tester) async {
      await tester.pumpWidget(_wrap(
        AssetThumbnail(asset: _fakeAsset(type: 'text')),
      ));
      await tester.pumpAndSettle();
    ...
    testWidgets('shows play button overlay for video type', (tester) async {
      await tester.pumpWidget(_wrap(
        AssetThumbnail(asset: _fakeAsset(type: 'video')),
      ));
      await tester.pumpAndSettle();
    ...
    testWidgets('shows favorite indicator when isFavorite is true', (tester) async {
      await tester.pumpWidget(_wrap(
        AssetThumbnail(
          asset: _fakeAsset(isFavorite: true),
          isFavorite: true,
        ),
      ));
      await tester.pumpAndSettle();
    ...
    testWidgets('shows generic icon for unknown type', (tester) async {
      await tester.pumpWidget(_wrap(
        AssetThumbnail(asset: _fakeAsset(type: 'other')),
      ));
      await tester.pumpAndSettle();
